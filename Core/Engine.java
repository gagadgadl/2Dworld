...
public class Engine {
    ...
    private TETile[][] world = new TETile[(int) (0.5*WIDTH)][(int) (42)];
    private StringBuilder record = new StringBuilder();
    private Position avatarPos = new Position(0, 0);
    private Position GoalPos= new Position(0, 1);
    ...
    public void interactWithKeyboard() {
        ...
        ter.initialize(WIDTH, HEIGHT,1,5);
        drawStartMenu();
        while (!gameOver) {
            ...
            if(avatarPos.x==GoalPos.x & avatarPos.y==GoalPos.y){
                gameOver = true;
    ...
    private void takeAction(InputSource source, char action) {
        ...
        if (action == 'N') {
            ...
            Position[] posA = WorldGenerator.createWorld(world, random);
            avatarPos = posA[0];
    ...
    private void tileInfo(Position mousePos) {
        ...
        StdDraw.text(10, 50, world[mousePos.x][mousePos.y].description());
        StdDraw.show();
    }
    ...
    private void drawStartMenu() {
        ...
        StdDraw.setFont(font);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(WIDTH / 2, HEIGHT * 3 / 4, "CS61B: Project 3 by Wang Ge");
        // Draw menu options.
    ...
    private void drawSeed(String s) {
        ...
        StdDraw.setFont(font);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(WIDTH / 2, HEIGHT * 6 / 10, "Please type a number, press 'Y' to confirm");
        // Display seed typed.
